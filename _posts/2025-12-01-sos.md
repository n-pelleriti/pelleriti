...
Since any sum of squares is clearly nonnegative, this *SOS decomposition* serves as a certificate of nonnegativity. The key insight from [[1]](#ref-1) is that checking whether such a decomposition exists can be formulated as a _Semidefinite Program_. 
...
Traditional methods like Newton polytope with diagonal consistency, chordal sparsity exploitation, and TSSOS [[4]](#ref-4) provide rule-based approaches to reducing basis size. 
...
We first demonstrate performance on challenging large-scale configurations, comparing against state-of-the-art SOS solvers: SoS.jl [[6]](#ref-6) (standard Newton polytope), TSSOS [[4]](#ref-4) (exploiting term sparsity), and Chordal-TSSOS [[5]](#ref-5) (exploiting chordal sparsity).
